                    ...
                    <div className="py-24 md:pb-32 lg:pb-36 lg:pt-64">
                        <div className="relative mx-auto flex max-w-7xl flex-col px-6 lg:block lg:px-12">
                            <div className="mx-auto max-w-lg text-center lg:ml-0 lg:max-w-full lg:text-left">
                                ...
                                <p className="mt-8 max-w-2xl text-balance text-lg text-white">Pengadaan energi , PLTS, ME, TI, dan logistik dalam satu mitra. Fokus pada keselamatan kerja, kepatuhan, dan ketepatan eksekusi.</p>
                                ...
                                <div className="mt-12 flex flex-col items-center justify-center gap-2 sm:flex-row lg:justify-start">
                                    ...
                                    {/* <Button
                                        ...
                                        size="lg"
                                        variant="ghost"
                                        className="h-12 rounded-full px-5 text-base hover:bg-zinc-950/5 dark:hover:bg-white/5 text-white">
                                        <Link href="#link">
                                            <span className="text-nowrap">Our Company Profile</span>
                                        </Link>
                                    </Button> */}
                                </div>
                            </div>
                    ...
                    <div className="group relative m-auto max-w-7xl px-6">
                        <div className="flex flex-col items-center md:flex-row">
                            <div className="md:max-w-44 md:border-r md:pr-6">
                                <p className="text-end text-sm">Trusted by Big Company</p>
                            </div>
